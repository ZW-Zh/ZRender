...
static TCHAR szWindowClass[] = _T("ZRender");

// The string that appears in the application's title bar.
static TCHAR szTitle[] = _T("ZRender");
...
static void register_window_class()
{
	...
	wc.lpszClassName = szTitle;					//该窗口类的名字
...
int window_init(int width, int height)
{
	...
	//创建窗口
	window->h_window = CreateWindow(szWindowClass, szTitle,
